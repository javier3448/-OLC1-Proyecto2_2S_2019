...
{
    public class IntOperation : IOperates
    {
        private static readonly IntOperation Instance = new IntOperation();

        public static IntOperation GetInstance()
        {
            return Instance;
        }
        ...
        {
            var result = new MyInt(-((MyInt)obj0).Int);
            return result;
        }
        #endregion
